...
#  Created on Sun Feb 13 23:32:05 2022                
#                                                     
#######################################################
...
set sprCreateIeStripeThreshold 1.0
clearGlobalNets
globalNetConnect VDD -type pgpin -pin {} -inst * -module {}
globalNetConnect VSS -type pgpin -pin {} -inst * -module {}
clearGlobalNets
...
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -preCTS -hold -pathReports -slackReports -numPaths 50 -prefix RISCV_preCTS -outDir timingReports
